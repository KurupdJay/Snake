...
class Game:
    ...
    def show_game_over(self):
        ...
        line1 = font.render(f'Game is over! Your score is {self.snake.length}', True, (159, 255, 128))
        self.surface.blit(line1, (100,250))
        font = pygame.font.SysFont('ariel', 60)
        line2 = font.render(f'To play again press Enter.', True, (159, 255, 128))
        self.surface.blit(line2, (100, 300))
        line3 = font.render(f'To exit press Escape!', True, (159, 255, 128))
    ...
    def display_score(self):
        ...
        score = font.render(f'Score: {self.snake.length}', True, (159, 255, 128))
